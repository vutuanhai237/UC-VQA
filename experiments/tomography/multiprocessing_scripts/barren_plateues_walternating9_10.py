...
for num_layers in layers:
    ...
    for i in range(0, 200):
        ...
        G = qsee.gradient.qng(qc.copy(), thetas, qsee.ansatz.create_Walternating_layered_ansatz, num_layers = num_layers)
        grad_loss = qsee.measure.grad_loss(
            qc, 
            qsee.ansatz.create_Walternating_layered_ansatz,
    ...
    print(np.var(t))
    ts.append(np.var(t))
np.savetxt("./barren_walternating9_10.csv", ts, delimiter=",")