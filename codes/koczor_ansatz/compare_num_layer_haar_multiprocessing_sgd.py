...
psi_hat , rho_psi_hat = qtm.base.extract_state(qc1)
    ...
    np.savetxt("../../experiments/koczor_ansatz_15layer_sgd/" + str(num_layers) + "/loss_values_haar.csv", loss_values_haar, delimiter=",")
    np.savetxt("../../experiments/koczor_ansatz_15layer_sgd/" + str(num_layers) + "/thetass_haar.csv", thetass_haar, delimiter=",")
    np.savetxt("../../experiments/koczor_ansatz_15layer_sgd/" + str(num_layers) + "/traces_haar.csv", traces_haar, delimiter=",")
    np.savetxt("../../experiments/koczor_ansatz_15layer_sgd/" + str(num_layers) + "/fidelities_haar.csv", fidelities_haar, delimiter=",")
