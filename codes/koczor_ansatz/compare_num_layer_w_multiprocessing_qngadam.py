...
psi_hat , rho_psi_hat = qtm.base.extract_state(qc1)
    ...
    print('Writting ...')
    np.savetxt("../../experiments/linear_ansatz_15layer_qngadam/" + str(num_layers) + "/loss_values_w.csv", loss_values_w, delimiter=",")
    np.savetxt("../../experiments/linear_ansatz_15layer_qngadam/" + str(num_layers) + "/thetass_w.csv", thetass_w, delimiter=",")
    np.savetxt("../../experiments/linear_ansatz_15layer_qngadam/" + str(num_layers) + "/traces_w.csv", traces_w, delimiter=",")
    np.savetxt("../../experiments/linear_ansatz_15layer_qngadam/" + str(num_layers) + "/fidelities_w.csv", fidelities_w, delimiter=",")
