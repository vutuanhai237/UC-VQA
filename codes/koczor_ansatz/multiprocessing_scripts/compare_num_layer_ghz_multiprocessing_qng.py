...
psi_hat , rho_psi_hat = qtm.base.extract_state(qc1)
    ...
    np.savetxt("../../experiments/linear_ansatz_15layer_qng/" + str(num_layers) + "/loss_values_ghz.csv", loss_values_ghz, delimiter=",")
    np.savetxt("../../experiments/linear_ansatz_15layer_qng/" + str(num_layers) + "/thetass_ghz.csv", thetass_ghz, delimiter=",")
    np.savetxt("../../experiments/linear_ansatz_15layer_qng/" + str(num_layers) + "/traces_ghz.csv", traces_ghz, delimiter=",")
    np.savetxt("../../experiments/linear_ansatz_15layer_qng/" + str(num_layers) + "/fidelities_ghz.csv", fidelities_ghz, delimiter=",")
