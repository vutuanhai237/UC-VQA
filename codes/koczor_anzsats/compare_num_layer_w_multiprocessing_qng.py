...
def run_w(num_layers, num_qubits):
    ...
    print('Writting ...')
    np.savetxt("../../experiments/koczor_ansatz_15layer/" + str(num_layers) + "/loss_values_w.csv", loss_values_w, delimiter=",")
    np.savetxt("../../experiments/koczor_ansatz_15layer/" + str(num_layers) + "/thetass_w.csv", thetass_w, delimiter=",")
    np.savetxt("../../experiments/koczor_ansatz_15layer/" + str(num_layers) + "/traces_w.csv", traces_w, delimiter=",")
    np.savetxt("../../experiments/koczor_ansatz_15layer/" + str(num_layers) + "/fidelities_w.csv", fidelities_w, delimiter=",")
